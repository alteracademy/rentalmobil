...
<div class="navbar-header" style="background: #0064d2 !important">
    ...
    <a class="navbar-brand" href="<?php echo base_url('admin/dashboard');?>" style="color: #fff">Wahyu Rent</a>
</div>
<ul class="nav navbar-right top-nav" style="background: #0064d2">
    <!--            <li class="dropdown">-->
