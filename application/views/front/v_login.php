...
<body style="background: #0064d2 !important">
<!-- contact-form -->
<div class="message warning">
    <div class="inset">
        <div class="login-head" style="background-color: #0064d2">
            <h1>Login Form</h1>
        ...
        <form method="post" action="">
            ...
            <div class="clear"> </div>
            <p style="margin-top: 20px;">Belum punya akun? <span><a style="color: #0064d2" href="<?= base_url('index/registrasi') ?>">Daftar Sekarang</a></span></p>
