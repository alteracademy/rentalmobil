...
<div class="banner-bootom-w3-agileits">
	<div class="container">
		...
		<div class="col-md-4 single-right-left simpleCart_shelfItem" style="border: 1px solid #bdbdbd; border-radius: 10px; box-shadow: 2px 2px 5px 5px #bdbdbd;">
						...
						<div class="snipcart-details top_brand_home_details item_add single-item">
							<form action="" method="post" style="text-align: left">
								...
								<fieldset style="text-align: center; width: 100%">
									<input style="width: 100% !important;" type="submit" name="submit" value="Pesan" class="button">
								</fieldset>
							</form>
						</div>
